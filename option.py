...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/data/lqy/data/SR/',
...
parser.add_argument('--refinetor_deep', type=int, default=3,
                    help='the deep for refinetor')
parser.add_argument('--window_size', type=int, default=256,
                    help='local window size')
parser.add_argument('--encoder_embed_dim', type=int, default=128,
                    help='encoder_embed_dim')
parser.add_argument('--window', type=dict, default={1: 1, 3: 1, 5: 1, 7: 1},
                    help='encoder_embed_dim')
